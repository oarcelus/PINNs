...
history_csv_path = os.path.join(history_dir, "cell03_holdout_history.csv")
...
if __name__ == "__main__":
    ...
    logger = setup_logger(
        name="cell03_holdout",
        log_path=os.path.join(log_dir, "cell03_holdout.log"),
    )
        ...
        if test_metrics["loss"] < best_test_loss:
            ...
            if save_best_epoch:
                torch.save(
                    ...
                    os.path.join(save_dir, "cell03_holdout_best.pt"),
                )
    ...
    if save_last_epoch:
        torch.save(
            ...
            os.path.join(save_dir, "cell03_holdout_last.pt"),
        )
