...
- Do not independently decide what physical coordinate `ut` represents. The current final-column derivative versus first-column `Cycle Number` mismatch is a model-semantics change requiring an approved spec and targeted tests.
